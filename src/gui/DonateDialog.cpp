...
DonateDialog::DonateDialog(QWidget *parent) : QDialog(parent) {
    ...
    QLabel *content = new QLabel(
        ...
        "<p>"
        "Dear User,<br>"
        "I offer MidiEditor for free and I hope you enjoy it. Please note that I developed the editor during my spare "
        "time and that I've been working on it for more than four years by now! If MidiEditor is useful for you, "
        "please send me a little donation so that I can at least cover my huge coffee-bill ;)  <br>"
        "</p>"
        "<h3>How to donate</h3>"
        "<p>"
        "Donating is very simple - and secure. Please visit the \"Donate\" section at the editor's project page in "
        "order to make a donation.<br>"
        ...
        "<p>"
        "<a href=\"https://github.com/markusschwenk/midieditor\">Rate MidiEditor and provide feedback</a> to let me "
        "and other users know about how you liked the software!"
        "</p>"
        "</body>"
        "</html>");
