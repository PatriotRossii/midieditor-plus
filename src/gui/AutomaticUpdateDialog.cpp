...
AutomaticUpdateDialog::AutomaticUpdateDialog(QWidget *parent) : QDialog(parent) {
    ...
    QLabel *content = new QLabel(
        ...
        "installed version of MidiEditor and you operating system to a server which is located within the European "
        "Union."
        "</p>"
        "<p>"
