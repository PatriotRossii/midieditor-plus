...
UpdateDialog::UpdateDialog(Update *update, QWidget *parent) : QDialog(parent) {
    ...
    QLabel *content = new QLabel("<html>"
                                 "<body>"
                                 "<p>"
                                 "Good news: a new version of MidiEditor has been released and is ready to be "
                                 "downloaded and istalled on your system. "
                                 "Please read the instructions below to learn how to install the update."
                                 "</p>"
                                 "<h3>Update</h3>"
                                 "<p>"
                                 "<b>New version: </b> " +
                                 update->versionString() + " (Current version: " + QApplication::applicationVersion() +
                                 ")<br>" + "<b>Changes: </b> " + update->changelog() +
                                 "</p>"
                                 "<h3>How to install the Update</h3>"
                                 "<p>Click <a href=\"" +
                                 update->path() +
                                 "\">here</a> to download the update. The link will open a browser window which "
                                 "contains a website which allows you to download the update. Close MidiEditor and "
                                 "execute the downloaded file to install the new version of MidiEditor.</p>"
                                 "<h3>Disable automatic Updates</h3>"
                                 "<p>"
                                 "In order to disable the automatic updates, plese open the editor's settings and "
                                 "uncheck the checkbox \"Automatically check for Updates\""
                                 "</p>"
                                 "</body>"
                                 "</html>");
