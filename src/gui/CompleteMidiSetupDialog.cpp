...
CompleteMidiSetupDialog::CompleteMidiSetupDialog(QWidget *parent, bool alertAboutInput, bool alertAboutOutput)
    ...
    if (alertAboutInput) {
        connectInput = "<h3>Input is not connected</h3>"
                       "<p>"
                       "In order to record music, MidiEditor must be connected to a midi device that you will record "
                       "music on.</br>"
                       "</p>";
    }
    QLabel *content = new QLabel(QString("<html>"
                                 ...
                                 QString("<p>Please refer to the manual for further instructions.<p/>"
                                         "</body>"
                                         "</html>"));
